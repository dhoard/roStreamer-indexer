...
public class WindowsFileComparator implements Comparator<File>
{
  ...
  {	  
    ...
    {    
	    String str1p = str1.substring(0, str1.lastIndexOf("."));
	    String str2p = str2.substring(0, str2.lastIndexOf("."));
	    
	    if (str1p.length() < str2p.length())
	    {
	    	if (str2p.indexOf(str1p) == 0)
	    	{
	    		return -1;
	    	}
	    }
	    else if (str1p.length() > str2p.length())
	    {
	    	if (str1p.indexOf(str2p) == 0)
	    	{
	    		return 1;
	    	}
	    }
